...
if __name__ == "__main__":
    ...
    print("->")
    print(client.get_historical_marketcap_rankings(1741280855, 1741453655, include_exchanges=True))
    ...
    # print("Exchanges for WIF")
    # print("->")
    # print(client.get_exchanges_for_mc_symbol("WIF", "futures"))
