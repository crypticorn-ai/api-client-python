# client
    ...
    - OHLCV data with marketcap
    - Technical indicators (KER, SMA)
...
*HealthCheckApi* | [**health_check**](docs/HealthCheckApi.md#health_check) | **GET** / | Read Root
...
## Documentation For Models
 ...
 - [BaseResponseListDict](docs/BaseResponseListDict.md)
 - [BaseResponseListExchangeMapping](docs/BaseResponseListExchangeMapping.md)
 - [BaseResponseListStr](docs/BaseResponseListStr.md)
 - [ErrorResponse](docs/ErrorResponse.md)
 - [ExchangeMapping](docs/ExchangeMapping.md)
