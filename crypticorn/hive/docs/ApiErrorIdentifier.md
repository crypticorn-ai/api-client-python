...
* `BOT_STOPPING_STARTED` (value: `'bot_stopping_started'`)
...
* `EXCHANGE_SYSTEM_IS_BUSY` (value: `'exchange_system_is_busy'`)

* `EXCHANGE_SYSTEM_CONFIGURATION_ERROR` (value: `'exchange_system_configuration_error'`)
...
* `BEARER_TOKEN_EXPIRED` (value: `'bearer_token_expired'`)
...
* `INVALID_DATA_RESPONSE` (value: `'invalid_data_response'`)

* `INVALID_EXCHANGE_KEY` (value: `'invalid_exchange_key'`)

* `INVALID_MARGIN_MODE` (value: `'invalid_margin_mode'`)

* `INVALID_MODEL_NAME` (value: `'invalid_model_name'`)
...
* `MODEL_NAME_NOT_UNIQUE` (value: `'model_name_not_unique'`)
...
* `STRATEGY_ALREADY_EXISTS` (value: `'strategy_already_exists'`)
