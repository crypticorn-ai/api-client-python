...
class PaymentsApi:
    ...
    def get_payments_html_get(
        ...
        _param = self._get_payments_html_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_payments_html_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_payments_html_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_payments_html_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
