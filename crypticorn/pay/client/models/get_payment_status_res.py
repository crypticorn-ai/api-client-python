...
class GetPaymentStatusRes(BaseModel):
    ...
    payment_status: StrictStr = Field(description="Current payment status (waiting, confirming, confirmed, sending, partially_paid, finished, failed, refunded, expired)")
