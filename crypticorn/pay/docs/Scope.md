...
* `READ_COLON_METRICS_COLON_MARKETCAP` (value: `'read:metrics:marketcap'`)

* `READ_COLON_METRICS_COLON_INDICATORS` (value: `'read:metrics:indicators'`)

* `READ_COLON_METRICS_COLON_EXCHANGES` (value: `'read:metrics:exchanges'`)

* `READ_COLON_METRICS_COLON_TOKENS` (value: `'read:metrics:tokens'`)
