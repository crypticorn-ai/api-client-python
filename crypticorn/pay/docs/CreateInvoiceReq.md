...
create_invoice_req_instance = CreateInvoiceReq.from_json(json)
# print the JSON string representation of the object
print(CreateInvoiceReq.to_json())

# convert the object into a dict
create_invoice_req_dict = create_invoice_req_instance.to_dict()
# create an instance of CreateInvoiceReq from a dict
create_invoice_req_from_dict = CreateInvoiceReq.from_dict(create_invoice_req_dict)
```
