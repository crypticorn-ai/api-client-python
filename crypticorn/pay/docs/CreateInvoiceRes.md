...
create_invoice_res_instance = CreateInvoiceRes.from_json(json)
# print the JSON string representation of the object
print(CreateInvoiceRes.to_json())

# convert the object into a dict
create_invoice_res_dict = create_invoice_res_instance.to_dict()
# create an instance of CreateInvoiceRes from a dict
create_invoice_res_from_dict = CreateInvoiceRes.from_dict(create_invoice_res_dict)
```
