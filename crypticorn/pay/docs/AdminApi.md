...
async with client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = client.AdminApi(api_client)
    include = ['include_example'] # List[Optional[str]] | List of dependencies to include in the response. If not provided, all installed packages will be returned. (optional)
...
------------- | ------------- | ------------- | -------------
 **include** | [**List[Optional[str]]**](str.md)| List of dependencies to include in the response. If not provided, all installed packages will be returned. | [optional] 
