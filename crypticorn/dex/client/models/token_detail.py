...
class TokenDetail(BaseModel):
    ...
    strict_socials: Optional[Dict[str, Any]] = Field(default=None, description="Social media links", alias="strictSocials")
    __properties: ClassVar[List[str]] = ["name", "symbol", "mint", "description", "image", "strictSocials"]
