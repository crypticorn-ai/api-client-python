...
class Liquidity(BaseModel):
    ...
    Liquidity
    """ # noqa: E501
    usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Liquidity in USD")
    base: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Amount of base token in the pool")
    quote: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Amount of quote token in the pool")
