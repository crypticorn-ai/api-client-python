...
class SignalOverviewStats(BaseModel):
    ...
    """ # noqa: E501
    timestamp: StrictInt = Field(description="The unix timestamp of the stats calculation")
    total: StrictInt = Field(description="Total number of tokens analyzed")
    win_rate: Union[StrictFloat, StrictInt] = Field(description="Overall win rate as a percentage")
    avg_performance: Union[StrictFloat, StrictInt] = Field(description="Average performance as a percentage")
    median_performance: Union[StrictFloat, StrictInt] = Field(description="Median performance as a percentage")
    ...
    __properties: ClassVar[List[str]] = ["timestamp", "total", "win_rate", "avg_performance", "median_performance", "best_risk_category", "best_month", "best_holding_period", "best_launch_hour", "best_launch_day"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.best_risk_category is None and "best_risk_category" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.best_holding_period is None and "best_holding_period" in self.model_fields_set:
            _dict['best_holding_period'] = None

        # set to None if best_launch_hour (nullable) is None
        # and model_fields_set contains the field
        if self.best_launch_hour is None and "best_launch_hour" in self.model_fields_set:
