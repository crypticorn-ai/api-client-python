...
class TokenData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["token", "mcap", "price", "liquidity", "risk", "buys", "sells", "txns", "holders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": TokenDetail.from_dict(obj["token"]) if obj.get("token") is not None else None,
            "mcap": obj.get("mcap"),
            "price": obj.get("price"),
            "liquidity": obj.get("liquidity"),
            "risk": Risk.from_dict(obj["risk"]) if obj.get("risk") is not None else None,
            "buys": obj.get("buys"),
            "sells": obj.get("sells"),
            "txns": obj.get("txns"),
