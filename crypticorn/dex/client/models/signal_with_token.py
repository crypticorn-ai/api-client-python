...
class SignalWithToken(BaseModel):
    ...
    performance: StrictStr = Field(description="The performance in percent as a string. e.g. +100%")
    ...
    performance_float: Union[StrictFloat, StrictInt] = Field(description="The performance in float. e.g. +100% -> 2.0")
    __properties: ClassVar[List[str]] = ["ca", "name", "type", "risk", "performance", "price", "volume", "liquidity", "mcap", "called_at", "updated_at", "tg_id", "data", "performance_float"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": obj.get("price"),
            "volume": SignalVolume.from_dict(obj["volume"]) if obj.get("volume") is not None else None,
