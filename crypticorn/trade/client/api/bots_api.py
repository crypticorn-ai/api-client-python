...
from crypticorn.trade.client.models.paginated_response_futures_trading_action import PaginatedResponseFuturesTradingAction
from crypticorn.trade.client.models.paginated_response_order import PaginatedResponseOrder
...
class BotsApi:
    ...
    def get_bot_actions(
        ...
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="The number of items per page. Default is 100, max is 1000.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Union[PaginatedResponseFuturesTradingAction, Awaitable[PaginatedResponseFuturesTradingAction]]:
        """Get Bot Actions"""
        if self.is_sync:
    ...
    def get_bot_actions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Union[ApiResponse[PaginatedResponseFuturesTradingAction], Awaitable[ApiResponse[PaginatedResponseFuturesTradingAction]]]:
    ...
    def get_bot_orders_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Union[ApiResponse[PaginatedResponseOrder], Awaitable[ApiResponse[PaginatedResponseOrder]]]:
    ...
    def get_bots(
        ...
        sort_order: Annotated[Optional[StrictStr], Field(description="The order to sort by")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="The field to sort by")] = None,
        include_deleted: Annotated[Optional[StrictBool], Field(description="Whether to include deleted bots. Filter by status takes precedence over this. Defaults to True.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_bots_pnl(
        ...
        sort_order: Annotated[Optional[StrictStr], Field(description="The order to sort by")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="The field to sort by")] = None,
        window: Annotated[Optional[StrictStr], Field(description="Time window for PnL. Defaults to full (all time), or use period (last X days), month, quarter, or year for values since the start of that range.")] = None,
        period: Annotated[Optional[Annotated[int, Field(le=365, strict=True, ge=1)]], Field(description="The number of days to return the PnL for. Only used if `window` is `period`. Default is 30.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="The number of items to return. Defaults to None, meaning no limit.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="The type of PnL to return. Defaults to relative.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_bots_pnl_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Union[ApiResponse[Dict[str, List[PnL]]], Awaitable[ApiResponse[Dict[str, List[PnL]]]]]:
