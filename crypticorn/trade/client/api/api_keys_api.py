...
class APIKeysApi:
    ...
    def get_exchange_key_balances_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Union[ApiResponse[List[ExchangeKeyBalance]], Awaitable[ApiResponse[List[ExchangeKeyBalance]]]]:
    ...
    def _get_exchange_key_balances_sync_without_preload_content(
        ...
        return async_to_sync(self._get_exchange_key_balances_async_without_preload_content)(
        _request_timeout=_request_timeout,
        _request_auth=_request_auth,
        _content_type=_content_type,
        _headers=_headers,
    ...
    def get_exchange_keys_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Union[ApiResponse[List[ExchangeKey]], Awaitable[ApiResponse[List[ExchangeKey]]]]:
