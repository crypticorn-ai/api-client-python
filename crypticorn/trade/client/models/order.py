...
class Order(BaseModel):
    ...
    action_type: TradingActionType = Field(description="Type of trading action. Of type TradingActionType")
    status: StrictStr = Field(description="Trade status of the order. Of type OrderStatus")
    market_type: StrictStr = Field(description="Market type of the order. Of type MarketType")
    ...
    filled_perc: Optional[StrictStr] = Field(default='0', description="Percentage of the order filled")
    filled_qty: Optional[StrictStr] = Field(default='0', description="Quantity filled. Needed for pnl calculation. In the symbol's base currency.")
    sent_qty: Optional[StrictStr] = Field(default='0', description="Quantity sent to the exchange. In the symbol's base currency.")
    fee: Optional[StrictStr] = None
    leverage: Optional[StrictInt] = None
    order_details: Optional[Dict[str, Any]] = Field(default=None, description="Exchange specific details of the order")
    pnl: Optional[StrictStr] = None
    order_time: Optional[StrictInt] = None
    is_lost: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "id", "exchange", "symbol", "action_type", "status", "market_type", "trading_action_id", "execution_id", "exchange_order_id", "position_id", "api_key_id", "bot_id", "client_order_id", "common_symbol", "price", "margin_mode", "status_code", "filled_perc", "filled_qty", "sent_qty", "fee", "leverage", "order_details", "pnl", "order_time", "is_lost"]
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['new', 'filled', 'partially_filled', 'cancelled', 'failed']):
            raise ValueError("must be one of enum values ('new', 'filled', 'partially_filled', 'cancelled', 'failed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filled_perc": obj.get("filled_perc") if obj.get("filled_perc") is not None else '0',
            "filled_qty": obj.get("filled_qty") if obj.get("filled_qty") is not None else '0',
            "sent_qty": obj.get("sent_qty") if obj.get("sent_qty") is not None else '0',
            "fee": obj.get("fee"),
