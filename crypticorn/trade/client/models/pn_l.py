...
class PnL(BaseModel):
    ...
    pnl: Union[StrictFloat, StrictInt] = Field(description="The profit and loss, either absolute or relative depending on the request")
    cum_pnl: Union[StrictFloat, StrictInt] = Field(description="The cumulative profit and loss of the bot until the order (inclusive), either absolute or relative depending on the request")
