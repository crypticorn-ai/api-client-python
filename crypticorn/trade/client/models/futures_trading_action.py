...
class FuturesTradingAction(BaseModel):
    ...
    execution_id: Optional[StrictStr] = Field(default=None, description="UID for the execution of the order. A specific TP/SL execution ID of the opening order.")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "id", "leverage", "margin_mode", "execution_id", "open_order_execution_id", "action_type", "market_type", "strategy_id", "symbol", "limit_price", "allocation", "take_profit", "stop_loss", "expiry_timestamp"]
