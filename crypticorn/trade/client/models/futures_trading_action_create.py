...
class FuturesTradingActionCreate(BaseModel):
    ...
    """ # noqa: E501
    leverage: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=1, description="Leverage to use for futures trades. Default is 1.")
    margin_mode: Optional[StrictStr] = Field(default='isolated', description="Margin mode for futures trades. Default is isolated.")
    execution_id: Optional[StrictStr] = None
    open_order_execution_id: Optional[StrictStr] = None
    action_type: TradingActionType = Field(description="The type of action.")
    market_type: Optional[StrictStr] = Field(default='futures', description="The type of market the action is for. Must be set to futures.")
    ...
    allocation: StrictStr = Field(description="How much of bot's balance to use for the order (for open actions). How much of the reference open order (open_order_execution_id) to close (for close actions). 0=0%, 1=100%.")
    take_profit: Optional[List[TPSLCreate]] = None
    stop_loss: Optional[List[TPSLCreate]] = None
    expiry_timestamp: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["leverage", "margin_mode", "execution_id", "open_order_execution_id", "action_type", "market_type", "strategy_id", "symbol", "limit_price", "allocation", "take_profit", "stop_loss", "expiry_timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "margin_mode": obj.get("margin_mode") if obj.get("margin_mode") is not None else 'isolated',
            "execution_id": obj.get("execution_id"),
            "open_order_execution_id": obj.get("open_order_execution_id"),
            "action_type": obj.get("action_type"),
            "market_type": obj.get("market_type") if obj.get("market_type") is not None else 'futures',
            "strategy_id": obj.get("strategy_id"),
            "symbol": obj.get("symbol"),
            "limit_price": obj.get("limit_price"),
            "allocation": obj.get("allocation"),
            "take_profit": [TPSLCreate.from_dict(_item) for _item in obj["take_profit"]] if obj.get("take_profit") is not None else None,
            "stop_loss": [TPSLCreate.from_dict(_item) for _item in obj["stop_loss"]] if obj.get("stop_loss") is not None else None,
