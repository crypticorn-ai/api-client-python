...
class SpotTradingActionCreate(BaseModel):
    ...
    market_type: Optional[StrictStr] = Field(default='spot', description="The type of market the action is for. Must be set to spot.")
    ...
    __properties: ClassVar[List[str]] = ["execution_id", "open_order_execution_id", "action_type", "market_type", "strategy_id", "symbol", "limit_price", "allocation", "take_profit", "stop_loss", "expiry_timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "market_type": obj.get("market_type") if obj.get("market_type") is not None else 'spot',
