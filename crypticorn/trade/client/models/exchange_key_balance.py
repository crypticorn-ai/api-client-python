...
class ExchangeKeyBalance(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "futures": FuturesBalance.from_dict(obj["futures"]) if obj.get("futures") is not None else None,
            "spot": [SpotBalance.from_dict(_item) for _item in obj["spot"]] if obj.get("spot") is not None else None
        })
        return _obj
