...
class PaginatedResponseFuturesTradingAction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "total", "page", "page_size", "prev", "next", "last"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [FuturesTradingAction.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
