...
class VaultBot(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "id", "status", "strategy_id", "api_key_id", "exchange", "vault_details"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['running', 'stopping', 'stopped', 'deleted']):
            raise ValueError("must be one of enum values ('running', 'stopping', 'stopped', 'deleted')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vault_details": VaultDetails.from_dict(obj["vault_details"]) if obj.get("vault_details") is not None else None
        })
        return _obj
