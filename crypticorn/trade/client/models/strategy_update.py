...
class StrategyUpdate(BaseModel):
    ...
    performance_fee: Optional[Union[Annotated[float, Field(le=1.0, strict=True, ge=0.0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "exchanges", "enabled", "performance_fee"]
