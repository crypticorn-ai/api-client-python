...
class TPSL(BaseModel):
    ...
    allocation: StrictStr = Field(description="Percentage of the open order to sell. All allocations must sum up to 1. Use this allocation again when closing the order.")
    execution_id: Optional[StrictStr] = Field(default=None, description="Execution ID of the order.")
    __properties: ClassVar[List[str]] = ["price_delta", "price", "allocation", "execution_id"]
