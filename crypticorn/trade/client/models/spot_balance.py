...
class SpotBalance(BaseModel):
    ...
    frozen: Union[StrictFloat, StrictInt] = Field(description="Frozen funds not available for use")
    allocated: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["asset", "balance", "available", "frozen", "allocated"]
