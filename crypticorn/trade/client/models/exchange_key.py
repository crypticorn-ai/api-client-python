...
class ExchangeKey(BaseModel):
    ...
    deleted: Optional[StrictBool] = Field(default=False, description="Whether the API key has been deleted.")
    type: StrictStr = Field(description="The type of the API key.")
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "id", "label", "user_id", "exchange", "deleted", "type"]
