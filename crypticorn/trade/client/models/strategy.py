...
class Strategy(BaseModel):
    ...
    exchanges: List[StrictStr] = Field(description="Exchanges supported by the strategy.")
    ...
    leverage: Annotated[int, Field(strict=True, ge=1)] = Field(description="Leverage for the strategy")
    market_type: StrictStr = Field(description="Market of operation of the strategy")
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "id", "name", "description", "exchanges", "enabled", "identifier", "margin_mode", "leverage", "market_type"]
